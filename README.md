...
- `js/jarvis-data.js` + `js/jarvis-data2.js` — the brain's speeches, jokes, facts, weather codes
- `js/jarvis.js` — the brain logic (`jarvisRespond()`); `js/talk.js` — the talk page UI (mic, speech, typing)
...
The intelligence lives in **`js/jarvis.js`** (`jarvisRespond()` — the rule engine) and
**`js/jarvis-data.js` / `js/jarvis-data2.js`** (the speeches, jokes and facts).
Add a rule to `jarvis.js`, or a line to the data files, and you're done. The speech UI
