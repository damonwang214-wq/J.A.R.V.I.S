/* J.A.R.V.I.S. — brain data: short speeches. {T0} placeholders are filled by jarvis.js via f(). */
window.JARVIS_DATA2 = {
...
maker: `I was built by my creator{T0} to keep things running smoothly. Let's just say my creator shows considerable promise, and excellent taste in assistants.`,
...
fallback: `I'm afraid I didn't quite catch that, {T0}. I'm a butler, not a miracle worker. Say "help" and I'll list what I can do.`,
...
window.JARVIS_DATA2.f = function (s, o) { return s.replace(/\{T(\d+)\}/g, function (m, i) { return o[+i]; }); };
